"""Kata - Playing on a chessboard

completed at: 2023-09-22 12:42:54
by: Jakub Červinka
...
def game(n):
    result = n ** 2 / 2
    result = fractions.Fraction.from_float(result).limit_denominator()
    if result.denominator == 1:
        return [result.numerator]
    return list(result.as_integer_ratio())
