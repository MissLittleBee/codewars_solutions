"""Kata - Coding Meetup #8 - Higher-Order Functions Series - Will all continents be represented?

completed at: 2023-06-01 20:38:03
by: Jakub Červinka
...
def all_continents(lst): 
    present_continents = Counter(n['continent'] for n in lst)
    mandatory_continents = ('Africa', 'Americas', 'Asia', 'Europe', 'Oceania')
    return all(cnt in present_continents for cnt in mandatory_continents)
